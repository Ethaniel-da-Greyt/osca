...
<div class="container-fluid">
    <div class="card mt-4 shadow-sm border-0 mb-5">
        <div class="card-header bg-dark text-white fw-bold fs-5"><?= esc($n['firstname'] . " " . $n['lastname']) ?>'s
            Profile</div>
        <div class="card-body">
            <div class="row mb-3">
                <div class="col-3">
            ...
            <form action="/osca/manage-record" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        ...
                        <input type="text" name="lastname" value="<?= esc($n['lastname']) ?>" class="form-control"
                            placeholder="Last Name*" required>
                    </div>
                    <div class="col-6">
                        <label for="" class="form-label fw-semibold">First Name</label>
                        <input type="text" name="firstname" value="<?= esc($n['firstname']) ?>" class="form-control"
                ...
                <div class="row mb-3">
                    <div class="col-4">
                        ...
                        <input type="text" name="middle_name" class="form-control" value="<?= esc($n['middle_name']) ?>"
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        ...
                        <select name="barangay" id="barangay<?= esc($n['id']) ?>"
                            class="form-select barangay-select text-center" required>
                    ...
                    <div class="col-6">
                        <label for="barangay_unit<?= esc($n['id']) ?>" class="form-label fw-semibold">Barangay
                            Unit</label>
                        <input type="text" name="unit" id="barangay_unit<?= esc($n['id']) ?>"
                            class="form-control barangay-unit text-muted" placeholder="Auto-filled Barangay Unit"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-4">
                        ...
                        <label for="" class="text-muted" style="font-size:smaller;">Auto-calculated based on
                            birthdate</label>
                    </div>
                    <div class="col-4">
                        <label for="" class="form-label fw-semibold">OSCA ID No.</label>
                        <input type="text" name="osca_id" value="<?= $n['osca_id'] ?>" class="form-control"
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        ...
                        <input type="date"
                            value="<?= esc(!empty($n['date_applied']) ? date('Y-m-d', strtotime($n['date_applied'])) : '') ?>"
                            name="date_applied" class="form-control">
                    </div>
                    <div class="col-6">
                        <label for="" class="form-label fw-semibold">Date Issued</label>
                        <input type="date" name="date_issued" class="form-control"
                            value="<?= esc(!empty($n['date_issued']) ? date('Y-m-d', strtotime($n['date_issued'])) : '') ?>">
                    </div>
                </div>
                <div class="mb-3">
                    <label for="" class="form-label fw-semibold">Remarks</label>
                    <textarea name="remarks" value="<?= esc($n['remarks']) ?>" class="form-control"
                        placeholder="Remarks here*"><?= esc($n['remarks']) ?></textarea>
                </div>

                <div class="d-flex justify-content-between align-items-center gap-2">
                    <a href="print/<?= $n['id'] ?>" class="btn btn-success"><i class="fa-regular fa-id-badge"></i>
                        Print
                        ID</a>
                    <div class="">
