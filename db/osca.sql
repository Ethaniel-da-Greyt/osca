...
--
-- Host: localhost:3306
-- Generation Time: Oct 23, 2025 at 04:01 AM
...
CREATE TABLE `masterlist` (
  ...
  `barangay` varchar(150) COLLATE utf8mb4_general_ci NOT NULL,
  `unit` int NOT NULL,
  `birthdate` date NOT NULL,
  `age` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `osca_id` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `users` (`id`, `firstname`, `lastname`, `username`, `password`, `role`, `isDelete`, `created_at`) VALUES
(1, 'Osca', 'Admin', 'admin', '$2y$10$5Y6hpUcCTlPEGp.D9OPL.O6eBhmStpBjNML4OywGDQiiPFGEwZahG', 'admin', 0, '2025-10-17 12:22:32'),
(2, 'Mi', 'So', 'miso', '$2y$10$DJjnRZoEznXeOnZ1Mpa1j.FIEVeLAtEKlcBjvfKFyb67fE5qC6QBq', 'user', 0, '2025-10-17 13:06:34'),
(3, 'Jerome', 'Bringuez', 'jerm', '$2y$10$wTN50GfN0SwdhijtBtaEmu8Eq0s4KIqlz.eRNEpYGSonzCHLDN366', 'user', 0, '2025-10-23 11:40:21');
